...
export default function Approach() {
  return (
    <section id="enfoque" className="py-24 bg-white border-b border-azul/10">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          {/* Pillar 1: Analítica y Negocio */}
          <div className="p-8 border border-azul/10 bg-blanco/50 hover:border-ocre transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 bg-azul text-white flex items-center justify-center font-serif text-xl font-bold mb-6">
                01
              </div>
              <h3 className="font-serif text-2xl font-bold text-azul mb-4">
                Visión Analítica
              </h3>
              <p className="font-sans text-sm text-azul/85 leading-relaxed font-light">
            ...
            <div className="mt-6 pt-6 border-t border-azul/5 flex items-center gap-2 text-[10px] font-mono uppercase tracking-wider text-ocre">
              <span>Orientación a Métricas</span>
              <ArrowRight className="w-3.5 h-3.5" />
            </div>
          </div>

          {/* Pillar 2: Creatividad Visual */}
          <div className="p-8 border border-azul/10 bg-blanco/50 hover:border-ocre transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 bg-ocre text-white flex items-center justify-center font-serif text-xl font-bold mb-6">
                02
              </div>
              <h3 className="font-serif text-2xl font-bold text-azul mb-4">
                Diseño & Detalle
          ...
          {/* Pillar 3: Liderazgo Operativo */}
          <div className="p-8 border border-azul/10 bg-blanco/50 hover:border-ocre transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 bg-rosa text-azul flex items-center justify-center font-serif text-xl font-bold mb-6">
                03
              </div>
              <h3 className="font-serif text-2xl font-bold text-azul mb-4">
                Gestión de Equipos
        ...
        {/* Agency vs Consulting Highlight Block */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch mb-20 bg-azul text-white p-8 md:p-12">
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/10 text-rosa text-[9px] font-bold uppercase tracking-[0.25em] mb-6">
              ...
              <p className="font-sans text-sm text-slate-300 leading-relaxed font-light mb-6">
                Tras más de 10 años colaborando con agencias externas, conozco perfectamente sus debilidades. Las agencias suelen vender paquetes preestablecidos, rotan constantemente a sus diseñadores y redactores juniors, y raramente comprenden los números internos de tu negocio.
              </p>
            </div>
          </div>
          <div className="lg:col-span-7 flex flex-col justify-center gap-6 border-t lg:border-t-0 lg:border-l border-white/15 pt-8 lg:pt-0 lg:pl-12">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="p-1 bg-ocre text-white shrink-0 mt-0.5">
        ...
        {/* FOMO Streaming Featured Section */}
        <div className="border border-azul/10 p-8 md:p-12 bg-rosa/15 relative overflow-hidden">
          <div className="absolute right-0 bottom-0 w-96 h-96 bg-ocre/5 rounded-full blur-3xl -z-10" />
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-azul text-white text-[9px] font-bold uppercase tracking-[0.25em] mb-4">
                <Radio className="w-3.5 h-3.5 text-rosa" />
                FOMO STREAMING MEDIA
              </div>
              <h3 className="font-serif text-3xl md:text-4xl font-bold text-azul mb-4">
                FOMO Streaming: <span className="font-normal italic text-ocre">Branding en Acción</span>
              </h3>
              ...
              <div className="inline-block p-5 bg-white/95 border-l-4 border-ocre shadow-xs mb-6">
            ...
            <div className="lg:col-span-4 flex flex-col items-center justify-center text-center p-6 bg-white border border-azul/10 shadow-sm">
              ...
              <p className="text-xs text-azul/70 leading-relaxed font-light mb-4">
              ...
              <a 
                ...
                className="text-xs font-mono font-bold uppercase tracking-widest text-azul hover:text-ocre transition-colors border-b border-azul hover:border-ocre pb-0.5"
              >
                Ver los programas →
              </a>
            </div>
